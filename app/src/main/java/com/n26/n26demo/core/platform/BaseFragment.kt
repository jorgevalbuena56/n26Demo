...
import com.n26.n26demo.core.extension.appContext
import com.n26.n26demo.core.extension.viewContainer
...
abstract class BaseFragment : Fragment() {
    ...
    val appComponent: ApplicationComponent by lazy(mode = LazyThreadSafetyMode.NONE) {
        (activity?.application as BitCoinChartApplication).appComponent
    }
